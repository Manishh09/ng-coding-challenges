...
export class LoginComponent {
  ...
  onSubmit() {
    ...
    // Navigate to returnUrl or default to dashboard workspace
    const returnUrl = this.route.snapshot.queryParams['returnUrl'] || '/challenges/angular-routing/admin-dashboard-access/workspace';
